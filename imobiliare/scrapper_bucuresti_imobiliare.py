...
def main():
    try:
        ...
        base_url = 'https://www.imobiliare.ro/inchirieri-apartamente/bucuresti/'
        ...
        for page_number in range(1, last_page + 1):
            ...
            base_crawl_url = 'https://www.imobiliare.ro/inchirieri-apartamente/bucuresti?pagina='
        ...
        helper_functions.insert_headers_to_csv("/home/dan/PycharmProjects/DissertationProject/csv_files/",
                                             "bucuresti_imobiliare.csv", headers)

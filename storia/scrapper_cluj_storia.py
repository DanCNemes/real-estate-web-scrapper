...
with profiler:
    def main():
        ...
        try:
            base_url = 'https://www.storia.ro/inchiriere/apartament/cluj/cluj-napoca/'
            ...
            for page_number in range(1, last_page + 1):
                ...
                base_crawl_url = 'https://www.storia.ro/inchiriere/apartament/cluj/cluj-napoca/?page='
...
profiler.dump_stats('/home/dan/PycharmProjects/DissertationProject/profiler_stats.txt')

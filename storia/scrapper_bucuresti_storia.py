...
def main():
    ...
    try:
        base_url = 'https://www.storia.ro/inchiriere/apartament/bucuresti/'
        ...
        for page_number in range(1, last_page + 1):
            ...
            base_crawl_url = 'https://www.storia.ro/inchiriere/apartament/bucuresti/?page='
        ...
        helper_functions.insert_headers_to_csv(
            "/home/dan/PycharmProjects/DissertationProject/csv_files/", "bucuresti_storia.csv", headers)
    except:
        helper_functions.insert_headers_to_csv(
            "/home/dan/PycharmProjects/DissertationProject/csv_files/", "bucuresti_storia.csv", headers)

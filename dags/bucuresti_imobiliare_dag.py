...
run_webscrapper = BashOperator(
    task_id='web_scrapper_bucuresti_imobiliare',
    bash_command='python /home/dan/PycharmProjects/DissertationProject/imobiliare/scrapper_bucuresti_imobiliare.py',
    dag=dag)

run_processer = BashOperator(
    task_id='csv_processer',
    bash_command='python /home/dan/PycharmProjects/DissertationProject/processers/bucuresti_imobiliare_processer.py',
    dag=dag)

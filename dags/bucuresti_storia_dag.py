...
run_webscrapper = BashOperator(
    task_id='web_scrapper_bucuresti_storia',
    bash_command='python /home/dan/PycharmProjects/DissertationProject/imobiliare/scrapper_bucuresti_storia.py',
    dag=dag)

run_processer = BashOperator(
    task_id='csv_processer',
    bash_command='python /home/dan/PycharmProjects/DissertationProject/processers/bucuresti_storia_processer.py',
    dag=dag)

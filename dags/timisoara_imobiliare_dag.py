...
run_webscrapper = BashOperator(
    ...
    bash_command='python /home/dan/PycharmProjects/DissertationProject/imobiliare/scrapper_timisoara_imobiliare.py',
    dag=dag)

run_processer = BashOperator(
    task_id='csv_processer',
    bash_command='python /home/dan/PycharmProjects/DissertationProject/processers/timisoara_imobiliare_processer.py',
    dag=dag)

...
run_webscrapper = BashOperator(
    ...
    bash_command='python /home/dan/PycharmProjects/DissertationProject/storia/scrapper_timisoara_storia.py',
    dag=dag)

run_processer = BashOperator(
    task_id='csv_processer',
    bash_command='python /home/dan/PycharmProjects/DissertationProject/processers/timisoara_storia_processer.py',
    dag=dag)
